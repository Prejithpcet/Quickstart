...
export default function Home() {
  return (
    <>
      <div
        id="home"
        className="home background-main w-full h-[100vh] bg-indigo-200 flex flex-col justify-center relative"
      >
        <main className=" flex flex-col items-end text-white relative z-9 px-5">
          <h1 className="text-[6rem]">QuickStart</h1>
          <p className="text-[1rem]">Solution to all your problems</p>
        </main>
      </div>
      <div className="home2">
      ...
      <div
        id="about"
        className="home3 w-[100%] h-[120vh] bg-[var(--second)] mt-[-200px] flex"
      >
        <div className="w-[70%] h-[100vh] bg-[var(--first)] flex flex-col items-center justify-center p-[2rem]">
